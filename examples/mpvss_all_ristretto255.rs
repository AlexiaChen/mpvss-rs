...
fn main() {
    ...
    let secret_message = String::from("Hello MPVSS Example (Ristretto255).");
    ...
    let verify_result = p1.verify_distribution_shares(&distribute_shares_box);
    println!("verify_distribution_shares result: {}", verify_result);
